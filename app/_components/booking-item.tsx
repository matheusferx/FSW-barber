    ...
    <Sheet open={isSheetOpen} onOpenChange={handleSheetOpenChange}>
            ...
            <div className="flex flex-col gap-2 py-5 pl-5">
              ...
              <div className="flex items-center gap-2">
                <Avatar className="w-6 h-6">
                  <AvatarImage src={booking.service.barbershop.imageUrl} alt="User Avatar" />
                </Avatar>
      ...
      <SheetContent className='w-[85%]'>
        ...
        <div className="relative flex h-[180px] w-full items-end mt-6"> 
          ...
          <Card className='z-50 mb-3 w-full mx-5 rounded-xl'>
            ...
            {isConfirmed && (
              <Dialog>
                <DialogTrigger className="w-full">
                  <Button variant="destructive" className="w-full">Cancelar Reservar</Button>
                </DialogTrigger>
