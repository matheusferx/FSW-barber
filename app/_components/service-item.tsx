...
const ServiceItem = ({ service, barbershop }: ServiceItemProps) => {
    ...
    const hendleDateSelected = (date: Date | undefined) => {
        setSelectedDay(date)
    }
        ...
        <Card>
            <CardContent className="flex items-center gap-3 p-3">
                ...
                <div className="relative min-h-[110px] min-w-[110px] max-h-[110px] max-w-[110px]">
                    <Image src={service.imageUrl} alt={service.name} fill className="object-cover rounded-lg"/>
                </div>
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <Sheet open={bookingSheetIsOpen} onOpenChange={handleBookingSheetOpenChange}>
                            ...
                            <SheetContent className="px-0">
                                ...
                                <div className="border-solid border-b py-5 flex justify-center">
                                    <Calendar 
                                        mode="single" 
                                        locale={ptBR}
                                        selected={selectedDay}
                                        onSelect={hendleDateSelected}
